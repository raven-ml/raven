...
module Make (Backend : Nx_core.Backend_intf.S) = struct
  ...
  let data_manipulation_tests ctx =
    [
      test_case "blit" `Quick (fun () ->
          let src = Nx.ones ctx Nx.float32 shape_2x3 in
          let dst = Nx.zeros ctx Nx.float32 shape_2x3 in
          Nx.blit src dst;
          check_t "blit" shape_2x3 [| 1.; 1.; 1.; 1.; 1.; 1. |] dst);
      test_case "fill" `Quick (fun () ->
          let t = Nx.zeros ctx Nx.float32 shape_2x3 in
          let _ = Nx.fill 5.0 t in
          check_t "fill" shape_2x3 [| 5.; 5.; 5.; 5.; 5.; 5. |] t);
    ]

  let element_wise_binary_tests ctx =
    [
      test_case "add" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 3.0 in
          let b = Nx.full ctx Nx.float32 shape_2x3 2.0 in
          Nx.add a b |> check_t "add" shape_2x3 [| 5.; 5.; 5.; 5.; 5.; 5. |]);
      test_case "add_s" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 3.0 in
          Nx.add_s a 5.0
          |> check_t "add_s" shape_2x3 [| 8.; 8.; 8.; 8.; 8.; 8. |]);
      ...
      test_case "sub" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 5.0 in
          let b = Nx.full ctx Nx.float32 shape_2x3 2.0 in
          Nx.sub a b |> check_t "sub" shape_2x3 [| 3.; 3.; 3.; 3.; 3.; 3. |]);
      test_case "sub_s" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 10.0 in
          Nx.sub_s a 3.0
          |> check_t "sub_s" shape_2x3 [| 7.; 7.; 7.; 7.; 7.; 7. |]);
      ...
      test_case "mul_s" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 4.0 in
          Nx.mul_s a 3.0
      ...
      test_case "div" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 6.0 in
          let b = Nx.full ctx Nx.float32 shape_2x3 2.0 in
          Nx.div a b |> check_t "div" shape_2x3 [| 3.; 3.; 3.; 3.; 3.; 3. |]);
      test_case "div_s" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 12.0 in
          Nx.div_s a 3.0
          |> check_t "div_s" shape_2x3 [| 4.; 4.; 4.; 4.; 4.; 4. |]);
      test_case "rdiv_s" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 2.0 in
          Nx.rdiv_s 6.0 a
      ...
      test_case "pow" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 2.0 in
          let b = Nx.full ctx Nx.float32 shape_2x3 3.0 in
          Nx.pow a b |> check_t "pow" shape_2x3 [| 8.; 8.; 8.; 8.; 8.; 8. |]);
      test_case "pow_s" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 2.0 in
          Nx.pow_s a 3.0
          |> check_t "pow_s" shape_2x3 [| 8.; 8.; 8.; 8.; 8.; 8. |]);
      ...
      test_case "mod" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 7.0 in
          let b = Nx.full ctx Nx.float32 shape_2x3 3.0 in
          Nx.mod_ a b |> check_t "mod" shape_2x3 [| 1.; 1.; 1.; 1.; 1.; 1. |]);
      test_case "mod_s" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 7.0 in
          Nx.mod_s a 3.0
          |> check_t "mod_s" shape_2x3 [| 1.; 1.; 1.; 1.; 1.; 1. |]);
      ...
      test_case "maximum" `Quick (fun () ->
          let a = Nx.full ctx Nx.float32 shape_2x3 3.0 in
          let b = Nx.full ctx Nx.float32 shape_2x3 5.0 in
          Nx.maximum a b
  ...
  let comparison_tests ctx =
    [
      test_case "equal" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 3 |] [| 1.; 2.; 1. |] in
          let b = Nx.create ctx Nx.float32 [| 3 |] [| 1.; 3.; 1. |] in
      ...
      test_case "greater" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 3 |] [| 5.; 3.; 1. |] in
          let b = Nx.create ctx Nx.float32 [| 3 |] [| 3.; 3.; 2. |] in
      ...
      test_case "less" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 3 |] [| 1.; 3.; 5. |] in
          let b = Nx.create ctx Nx.float32 [| 3 |] [| 3.; 3.; 2. |] in
  ...
  let element_wise_unary_tests ctx =
    [
      ...
      test_case "atanh" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 3 |] [| 0.; 0.5; -0.5 |] in
          Nx.atanh a
          |> check_t ~eps:1e-6 "atanh" [| 3 |] [| 0.0; 0.549306; -0.549306 |]);
      test_case "round" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 4 |] [| 3.2; 3.7; -3.2; -3.7 |] in
      ...
      test_case "clip" `Quick (fun () ->
          let a =
            Nx.create ctx Nx.float32 [| 5 |] [| -2.; 0.; 5.; 10.; 12. |]
          in
      ...
      test_case "lerp" `Quick (fun () ->
          let start_t = Nx.zeros ctx Nx.float32 [| 3 |] in
          let end_t = Nx.full ctx Nx.float32 [| 3 |] 10.0 in
          let weight = Nx.create ctx Nx.float32 [| 3 |] [| 0.0; 0.5; 1.0 |] in
  ...
  let bitwise_tests ctx =
    [
      test_case "bitwise_and" `Quick (fun () ->
          let a = Nx.create ctx Nx.int32 [| 3 |] [| 7l; 12l; 15l |] in
          let b = Nx.create ctx Nx.int32 [| 3 |] [| 3l; 10l; 7l |] in
          Nx.bitwise_and a b |> check_t "bitwise_and" [| 3 |] [| 3l; 8l; 7l |]);
      test_case "bitwise_or" `Quick (fun () ->
          let a = Nx.create ctx Nx.int32 [| 3 |] [| 1l; 4l; 8l |] in
          let b = Nx.create ctx Nx.int32 [| 3 |] [| 2l; 2l; 7l |] in
      ...
      test_case "bitwise_not" `Quick (fun () ->
          let a = Nx.create ctx Nx.int32 [| 3 |] [| 0l; 1l; -1l |] in
      ...
      test_case "lshift" `Quick (fun () ->
          let a = Nx.create ctx Nx.int32 [| 3 |] [| 1l; 2l; 4l |] in
          Nx.lshift a 2 |> check_t "lshift" [| 3 |] [| 4l; 8l; 16l |]);
      test_case "rshift" `Quick (fun () ->
          let a = Nx.create ctx Nx.int32 [| 3 |] [| 4l; 8l; 16l |] in
          Nx.rshift a 2 |> check_t "rshift" [| 3 |] [| 1l; 2l; 4l |]);
    ]

  let logical_tests ctx =
    [
      test_case "logical_and" `Quick (fun () ->
          let a = Nx.create ctx Nx.int32 [| 4 |] [| 0l; 1l; 1l; 0l |] in
          let b = Nx.create ctx Nx.int32 [| 4 |] [| 0l; 0l; 1l; 1l |] in
          Nx.logical_and a b
          |> check_t "logical_and" [| 4 |] [| 0l; 0l; 1l; 0l |]);
      ...
      test_case "logical_xor" `Quick (fun () ->
          ...
          let b = Nx.create ctx Nx.int32 [| 4 |] [| 0l; 0l; 1l; 1l |] in
          Nx.logical_xor a b
          |> check_t "logical_xor" [| 4 |] [| 0l; 1l; 0l; 1l |]);
      test_case "logical_not" `Quick (fun () ->
          let a = Nx.create ctx Nx.int32 [| 3 |] [| 0l; 1l; 1l |] in
          Nx.logical_not a |> check_t "logical_not" [| 3 |] [| 1l; 0l; 0l |]);
    ]

  let special_value_tests ctx =
    [
      test_case "isnan" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 3 |] [| 1.0; nan; 0.0 |] in
          Nx.isnan a |> check_t "isnan" [| 3 |] [| 0; 1; 0 |]);
      test_case "isinf" `Quick (fun () ->
          let a =
            Nx.create ctx Nx.float32 [| 4 |]
              [| 1.0; infinity; neg_infinity; 0.0 |]
          in
          Nx.isinf a |> check_t "isinf" [| 4 |] [| 0; 1; 1; 0 |]);
      test_case "isfinite" `Quick (fun () ->
          let a =
            Nx.create ctx Nx.float32 [| 4 |] [| 1.0; infinity; nan; 0.0 |]
          in
          Nx.isfinite a |> check_t "isfinite" [| 4 |] [| 1; 0; 0; 1 |]);
    ]

  let ternary_tests ctx =
    [
      test_case "where" `Quick (fun () ->
          let cond = Nx.create ctx Nx.uint8 [| 5 |] [| 1; 0; 1; 0; 1 |] in
          let x = Nx.create ctx Nx.float32 [| 5 |] [| 1.; 2.; 3.; 4.; 5. |] in
          let y =
            Nx.create ctx Nx.float32 [| 5 |] [| 10.; 20.; 30.; 40.; 50. |]
          in
          Nx.where cond x y
          |> check_t "where" [| 5 |] [| 1.; 20.; 3.; 40.; 5. |]);
    ]

  let reduction_tests ctx =
    [
      ...
      test_case "max" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 5 |] [| 1.; 5.; 3.; 2.; 4. |] in
          Nx.max a |> check_t "max" [||] [| 5.0 |]);
      test_case "min" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 5 |] [| 5.; 1.; 3.; 2.; 4. |] in
      ...
      test_case "std" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 4 |] [| 1.; 3.; 5.; 7. |] in
          Nx.std a |> check_t ~eps:1e-6 "std" [||] [| 2.236068 |]);
      test_case "all" `Quick (fun () ->
          let a = Nx.create ctx Nx.int [| 4 |] [| 1; 1; 0; 1 |] in
          Nx.all a |> check_t "all with zero" [||] [| 0 |];
          let c = Nx.create ctx Nx.int [| 3 |] [| 1; 1; 1 |] in
          Nx.all c |> check_t "all without zero" [||] [| 1 |]);
      test_case "any" `Quick (fun () ->
          let a = Nx.create ctx Nx.int [| 4 |] [| 0; 0; 1; 0 |] in
          Nx.any a |> check_t "any with one" [||] [| 1 |];
          let c = Nx.create ctx Nx.int [| 3 |] [| 0; 0; 0 |] in
  ...
  let shape_manipulation_tests ctx =
    [
      test_case "reshape" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 shape_2x3 test_array in
      ...
      test_case "unflatten" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 6 |] test_array in
          Nx.unflatten 0 [| 2; 3 |] a
          |> check_t "unflatten" [| 2; 3 |] test_array);
      test_case "ravel" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 shape_2x3 test_array in
          Nx.ravel a |> check_t "ravel" [| 6 |] test_array);
      test_case "squeeze" `Quick (fun () ->
          let a = Nx.ones ctx Nx.float32 [| 1; 3; 1 |] in
      ...
      test_case "unsqueeze" `Quick (fun () ->
          let a = Nx.ones ctx Nx.float32 [| 3 |] in
      ...
      test_case "moveaxis" `Quick (fun () ->
          ...
          let expected =
            Nx.create ctx Nx.float32 [| 3; 4; 2 |]
              [|
                0.;
                12.;
                1.;
      ...
      test_case "expand" `Quick (fun () ->
          let a = Nx.ones ctx Nx.float32 [| 1; 3 |] in
      ...
      test_case "broadcast_arrays" `Quick (fun () ->
          let a = Nx.ones ctx Nx.float32 [| 1; 3 |] in
          let b = Nx.full ctx Nx.float32 [| 2; 1 |] 2.0 in
  ...
  let array_combination_tests ctx =
    [
      test_case "concatenate" `Quick (fun () ->
          let a =
            Nx.create ctx Nx.float32 [| 2; 3 |] [| 1.; 2.; 3.; 4.; 5.; 6. |]
          in
          let b = Nx.create ctx Nx.float32 [| 1; 3 |] [| 7.; 8.; 9. |] in
      ...
      test_case "array_split" `Quick (fun () ->
          let a =
            Nx.create ctx Nx.float32 [| 6 |] [| 1.; 2.; 3.; 4.; 5.; 6. |]
          in
  ...
  let type_conversion_tests ctx =
    [
      test_case "cast" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 3 |] [| 1.7; 2.3; 3.9 |] in
  ...
  let indexing_slicing_tests ctx =
    [
      ...
      test_case "set" `Quick (fun () ->
          let a = Nx.zeros ctx Nx.float32 shape_2x3 in
          let value = Nx.create ctx Nx.float32 [| 3 |] [| 7.; 8.; 9. |] in
          Nx.set [ 1 ] a value;
          check_t "set" shape_2x3 [| 0.; 0.; 0.; 7.; 8.; 9. |] a);
      test_case "unsafe_get" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 shape_2x3 test_array in
          check (float 1e-6) "unsafe_get [0,0]" 1.0 (Nx.unsafe_get [ 0; 0 ] a);
          check (float 1e-6) "unsafe_get [1,2]" 6.0 (Nx.unsafe_get [ 1; 2 ] a));
      test_case "unsafe_set" `Quick (fun () ->
          let a = Nx.zeros ctx Nx.float32 shape_2x3 in
          Nx.unsafe_set [ 0; 1 ] 42.0 a;
          Nx.unsafe_set [ 1; 2 ] 99.0 a;
          check (float 1e-6) "unsafe_set [0,1]" 42.0 (Nx.unsafe_get [ 0; 1 ] a);
  ...
  let neural_network_tests ctx =
    [
      ...
      test_case "correlate1d" `Quick (fun () ->
          ...
          in
          let w = Nx.create ctx Nx.float32 [| 1; 1; 3 |] [| 1.; 0.; -1. |] in
      ...
      test_case "avg_pool2d" `Quick (fun () ->
          ...
          check_t "avg_pool2d values" [| 1; 1; 2; 2 |]
            [| 3.5; 5.5; 11.5; 13.5 |] y);
  ...
  let random_tests ctx =
    [
      ...
      test_case "randint" `Quick (fun () ->
          let t = Nx.randint ctx Nx.int32 shape_2x3 0 ~high:10 in
          check_shape "randint shape" shape_2x3 t;
          (* Check all values are in range *)
          for i = 0 to 1 do
            for j = 0 to 2 do
              let v = Nx.unsafe_get [ i; j ] t in
              check bool "randint in range" true (v >= 0l && v < 10l)
            done
          done);
    ]

  let sorting_searching_tests ctx =
    [
      test_case "sort" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 5 |] [| 3.; 1.; 4.; 1.; 5. |] in
      ...
      test_case "argmax" `Quick (fun () ->
          let a = Nx.create ctx Nx.float32 [| 5 |] [| 3.; 1.; 5.; 2.; 4. |] in
  ...
  let display_formatting_tests ctx =
    [
      ...
      test_case "data_to_string" `Quick (fun () ->
          ...
          check bool "data_to_string contains data" true
            (String.contains str '1'));
      test_case "print_data" `Quick (fun () ->
          let a = Nx.ones ctx Nx.float32 [| 2; 2 |] in
          Nx.print_data a);
  ...
  let higher_order_tests ctx =
    [
      ...
      test_case "map preserves shape" `Quick (fun () ->
          let a =
            Nx.create ctx Nx.float32 [| 3; 2; 2 |]
  ...
  let suite backend_name ctx =
    [
      ("Sanity :: " ^ backend_name ^ " Creation Functions", creation_tests ctx);
      ( "Sanity :: " ^ backend_name ^ " Range Generation",
        range_generation_tests ctx );
      ( "Sanity :: " ^ backend_name ^ " Property Access",
        property_access_tests ctx );
      ( "Sanity :: " ^ backend_name ^ " Data Manipulation",
        data_manipulation_tests ctx );
      ( "Sanity :: " ^ backend_name ^ " Element-wise Binary Operations",
        element_wise_binary_tests ctx );
      ( "Sanity :: " ^ backend_name ^ " Comparison Operations",
        comparison_tests ctx );
      ( "Sanity :: " ^ backend_name ^ " Element-wise Unary Operations",
        element_wise_unary_tests ctx );
      ("Sanity :: " ^ backend_name ^ " Bitwise Operations", bitwise_tests ctx);
      ("Sanity :: " ^ backend_name ^ " Logical Operations", logical_tests ctx);
      ( "Sanity :: " ^ backend_name ^ " Special Value Checks",
        special_value_tests ctx );
      ("Sanity :: " ^ backend_name ^ " Ternary Operations", ternary_tests ctx);
      ( "Sanity :: " ^ backend_name ^ " Reduction Operations",
        reduction_tests ctx );
      ( "Sanity :: " ^ backend_name ^ " Shape Manipulation",
        shape_manipulation_tests ctx );
      ( "Sanity :: " ^ backend_name ^ " Array Combination",
        array_combination_tests ctx );
      ( "Sanity :: " ^ backend_name ^ " Type Conversion",
        type_conversion_tests ctx );
      ( "Sanity :: " ^ backend_name ^ " Indexing and Slicing",
        indexing_slicing_tests ctx );
      ("Sanity :: " ^ backend_name ^ " Linear Algebra", linear_algebra_tests ctx);
      ("Sanity :: " ^ backend_name ^ " Neural Network", neural_network_tests ctx);
      ( "Sanity :: " ^ backend_name ^ " Random Number Generation",
        random_tests ctx );
      ( "Sanity :: " ^ backend_name ^ " Sorting and Searching",
        sorting_searching_tests ctx );
      ( "Sanity :: " ^ backend_name ^ " Display and Formatting",
        display_formatting_tests ctx );
      ( "Sanity :: " ^ backend_name ^ " Higher-order Functions",
        higher_order_tests ctx );
    ]
end
