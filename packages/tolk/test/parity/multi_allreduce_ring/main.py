...
copies device to device — visible as per-chunk shrink/copy/add kernels,
unlike the naive path's one combine per device. LATE_ALLREDUCE=0 expands
the allreduce inline during the multi rewrite so its kernels are visible
in the schedule.
