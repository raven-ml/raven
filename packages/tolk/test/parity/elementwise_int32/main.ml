...
let kernel () =
  let p0 = U.param ~slot:0 ~dtype:i32_ptr ~shape:(U.const_int 256) () in
  let p1 = U.param ~slot:1 ~dtype:i32_ptr ~shape:(U.const_int 256) () in
  let p2 = U.param ~slot:2 ~dtype:i32_ptr ~shape:(U.const_int 256) () in
