...
- Complete BufferStorage, HostAllocator, per-device mappings and typed dispatch
  and transfer identities. Remove the nativeint-only transfer seam and Metal
  token workaround; preserve view lifetimes and 64-bit offsets. Port disk/view
  preparation rules against the new storage owner.
