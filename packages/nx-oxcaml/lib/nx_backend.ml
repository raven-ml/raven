...
let cast (type a b c d) ~(out : (c, d) t) (x : (a, b) t) : unit =
  let in_view = x.view in
  let out_view = out.view in
  match (x.buffer, out.buffer) with
  | Float64 src, Float32 dst ->
      Op_cast.cast_float64_float32 src dst in_view out_view;
  | Float64 src, Int8 dst ->
      Op_cast.cast_float64_int8 src dst in_view out_view;
  | Float64 src, Int16 dst ->
      Op_cast.cast_float64_int16 src dst in_view out_view;
  | Float64 src, Int32 dst ->
      Op_cast.cast_float64_int32 src dst in_view out_view;
  | Float64 src, Int64 dst ->
      Op_cast.cast_float64_int64 src dst in_view out_view;
  | Float64 src, Bool dst ->
      Op_cast.cast_float64_bool src dst in_view out_view;
  | Float32 src, Float64 dst ->
      Op_cast.cast_float32_float64 src dst in_view out_view;
  | Float32 src, Int8 dst ->
      Op_cast.cast_float32_int8 src dst in_view out_view;
  | Float32 src, Int16 dst ->
      Op_cast.cast_float32_int16 src dst in_view out_view;
  | Float32 src, Int32 dst ->
      Op_cast.cast_float32_int32 src dst in_view out_view;
  | Float32 src, Int64 dst ->
      Op_cast.cast_float32_int64 src dst in_view out_view;
  | Float32 src, Bool dst ->
      Op_cast.cast_float32_bool src dst in_view out_view;
  | Int8 src, Float64 dst ->
      Op_cast.cast_int8_float64 src dst in_view out_view;
  | Int8 src, Float32 dst ->
      Op_cast.cast_int8_float32 src dst in_view out_view;
  | Int8 src, Int16 dst ->
      Op_cast.cast_int8_int16 src dst in_view out_view;
  | Int8 src, Int32 dst ->
      Op_cast.cast_int8_int32 src dst in_view out_view;
  | Int8 src, Int64 dst ->
      Op_cast.cast_int8_int64 src dst in_view out_view;
  | Int8 src, Bool dst ->
      Op_cast.cast_int8_bool src dst in_view out_view;
  | Int16 src, Float64 dst ->
      Op_cast.cast_int16_float64 src dst in_view out_view;
  | Int16 src, Float32 dst ->
      Op_cast.cast_int16_float32 src dst in_view out_view;
  | Int16 src, Int8 dst ->
      Op_cast.cast_int16_int8 src dst in_view out_view;
  | Int16 src, Int32 dst ->
      Op_cast.cast_int16_int32 src dst in_view out_view;
  | Int16 src, Int64 dst ->
      Op_cast.cast_int16_int64 src dst in_view out_view;
  | Int16 src, Bool dst ->
      Op_cast.cast_int16_bool src dst in_view out_view;
  | Int32 src, Float64 dst ->
      Op_cast.cast_int32_float64 src dst in_view out_view;
  | Int32 src, Float32 dst ->
      Op_cast.cast_int32_float32 src dst in_view out_view;
  | Int32 src, Int8 dst ->
      Op_cast.cast_int32_int8 src dst in_view out_view;
  | Int32 src, Int16 dst ->
      Op_cast.cast_int32_int16 src dst in_view out_view;
  | Int32 src, Int64 dst ->
      Op_cast.cast_int32_int64 src dst in_view out_view;
  | Int32 src, Bool dst ->
      Op_cast.cast_int32_bool src dst in_view out_view;
  | Int64 src, Float64 dst ->
      Op_cast.cast_int64_float64 src dst in_view out_view;
  | Int64 src, Float32 dst ->
      Op_cast.cast_int64_float32 src dst in_view out_view;
  | Int64 src, Int8 dst ->
      Op_cast.cast_int64_int8 src dst in_view out_view;
  | Int64 src, Int16 dst ->
      Op_cast.cast_int64_int16 src dst in_view out_view;
  | Int64 src, Int32 dst ->
      Op_cast.cast_int64_int32 src dst in_view out_view;
  | Int64 src, Bool dst ->
      Op_cast.cast_int64_bool src dst in_view out_view;
  | Bool src, Float64 dst ->
      Op_cast.cast_bool_float64 src dst in_view out_view;
  | Bool src, Float32 dst ->
      Op_cast.cast_bool_float32 src dst in_view out_view;
  | Bool src, Int8 dst ->
      Op_cast.cast_bool_int8 src dst in_view out_view;
  | Bool src, Int16 dst ->
      Op_cast.cast_bool_int16 src dst in_view out_view;
  | Bool src, Int32 dst ->
      Op_cast.cast_bool_int32 src dst in_view out_view;
  | Bool src, Int64 dst ->
      Op_cast.cast_bool_int64 src dst in_view out_view;
