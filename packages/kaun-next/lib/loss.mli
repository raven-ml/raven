...
(** Loss functions.
    ...
    {!Rune_next.grad} requires of a training objective. Every loss is
    differentiable with respect to its predictions (or logits); targets are data
    and receive no gradients.
