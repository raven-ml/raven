...
let random_tests =
  [
    test "rand" (fun () ->
        let t = Nx.Rng.with_key (Nx.Rng.key 0) (fun () -> Nx.rand Nx.float32 shape_2x3) in
        ...
        Array.iter
          ...
          vals);
    test "randn" (fun () ->
        let t = Nx.Rng.with_key (Nx.Rng.key 1) (fun () -> Nx.randn Nx.float32 [| 100 |]) in
    ...
    test "randint" (fun () ->
        let t = Nx.Rng.with_key (Nx.Rng.key 2) (fun () -> Nx.randint ~high:10 shape_2x3) in
