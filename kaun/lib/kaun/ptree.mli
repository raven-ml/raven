...
val get_by_path : string -> ('layout, 'dev) t -> ('layout, 'dev) t
...
val set_by_path :
  string -> ('layout, 'dev) t -> ('layout, 'dev) t -> ('layout, 'dev) t
...
val validate_tree : ?path:string -> ('layout, 'dev) t -> unit
...
val list_named_params : ('layout, 'dev) t -> (string * string * int) list
...
val find_params_by_pattern :
  string -> ('layout, 'dev) t -> (string * ('layout, 'dev) tensor) list
...
val get_param_stats : ('layout, 'dev) t -> int * (string * int) list
