...
val train_epoch :
  state:('layout, 'dev) State.t ->
  dataset:(('layout, 'dev) tensor * ('layout, 'dev) tensor) Kaun_dataset.t ->
  loss_fn:
    (('layout, 'dev) tensor -> ('layout, 'dev) tensor -> ('layout, 'dev) tensor) ->
  ?progress:bool ->
  unit ->
...
val fit :
  ...
  loss_fn:
    (('layout, 'dev) tensor -> ('layout, 'dev) tensor -> ('layout, 'dev) tensor) ->
  ?metrics:('layout, 'dev) Metrics.Collection.t ->
  train_data:(('layout, 'dev) tensor * ('layout, 'dev) tensor) Kaun_dataset.t ->
  ?val_data:(('layout, 'dev) tensor * ('layout, 'dev) tensor) Kaun_dataset.t ->
  epochs:int ->
