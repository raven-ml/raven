...
(** Helper to convert Nx dtype to Metal_ops dtype *)
let nx_dtype_to_metal_dtype : type a b. (a, b) Nx_core.dtype -> metal_dtype =
  function
  | Nx_core.Float32 -> Float32
  | Nx_core.Int32 -> Int32
...
(** Helper to create a Metal buffer view (shared memory) onto an Nx *)
