...
external low_of : int16# -> t @@ portable
  = "caml_sse2_unreachable" "caml_int16x8_low_of_int16"
  [@@noalloc] [@@builtin]

external low_to : t -> int16# @@ portable
  = "caml_sse2_unreachable" "caml_int16x8_low_to_int16"
  [@@noalloc] [@@builtin]

external const1 : int16# -> t @@ portable
  = "caml_sse2_unreachable" "caml_int16x8_const1"
  [@@noalloc] [@@builtin]

external dup : t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_dup"
  [@@noalloc] [@@unboxed] [@@builtin]

external insert : (int[@untagged]) -> (t[@unboxed]) -> (int[@untagged]) -> (t[@unboxed]) @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_insert"
  [@@noalloc] [@@builtin]

external extract : (int[@untagged]) -> (t[@unboxed]) -> (int[@untagged]) @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_extract"
  [@@noalloc] [@@builtin]
...
external add : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_add"
  [@@noalloc] [@@unboxed] [@@builtin]

external sub : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_sub"
  [@@noalloc] [@@unboxed] [@@builtin]

external add_saturating : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_add_saturating"
  [@@noalloc] [@@unboxed] [@@builtin]

external add_saturating_unsigned : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_add_saturating_unsigned"
  [@@noalloc] [@@unboxed] [@@builtin]

external sub_saturating : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_sub_saturating"
  [@@noalloc] [@@unboxed] [@@builtin]

external sub_saturating_unsigned : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_sub_saturating_unsigned"
  [@@noalloc] [@@unboxed] [@@builtin]

external abs : t -> t @@ portable
  = "caml_sse2_unreachable" "caml_ssse3_int16x8_abs"
  [@@noalloc] [@@unboxed] [@@builtin]
...
external max : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_max"
  [@@noalloc] [@@unboxed] [@@builtin]

external min : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_min"
  [@@noalloc] [@@unboxed] [@@builtin]

external max_unsigned : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse41_int16x8_max_unsigned"
  [@@noalloc] [@@unboxed] [@@builtin]

external min_unsigned : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse41_int16x8_min_unsigned"
  [@@noalloc] [@@unboxed] [@@builtin]

(* ───── Comparison ───── *)

external cmpeq : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_cmpeq"
  [@@noalloc] [@@unboxed] [@@builtin]

external cmpgt : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_cmpgt"
  [@@noalloc] [@@unboxed] [@@builtin]
...
external horizontal_add : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_ssse3_int16x8_hadd"
  [@@noalloc] [@@unboxed] [@@builtin]

external horizontal_sub : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_ssse3_int16x8_hsub"
  [@@noalloc] [@@unboxed] [@@builtin]

external horizontal_add_saturating : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_ssse3_int16x8_hadd_saturating"
  [@@noalloc] [@@unboxed] [@@builtin]

external horizontal_sub_saturating : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_ssse3_int16x8_hsub_saturating"
  [@@noalloc] [@@unboxed] [@@builtin]

(* ───── Shifts ───── *)

external sll : t -> int64x2# -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_sll"
  [@@noalloc] [@@unboxed] [@@builtin]

external srl : t -> int64x2# -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_srl"
  [@@noalloc] [@@unboxed] [@@builtin]

external sra : t -> int64x2# -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_sra"
  [@@noalloc] [@@unboxed] [@@builtin]
...
external mul_low : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_mul_low"
  [@@noalloc] [@@unboxed] [@@builtin]

external mul_high : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_mul_high"
  [@@noalloc] [@@unboxed] [@@builtin]

external mul_high_unsigned : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_mul_high_unsigned"
  [@@noalloc] [@@unboxed] [@@builtin]

external mul_horizontal_add : t -> t -> int32x4# @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_mul_hadd"
  [@@noalloc] [@@unboxed] [@@builtin]

external mul_round : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_ssse3_int16x8_mul_round"
  [@@noalloc] [@@unboxed] [@@builtin]
...
external avg_unsigned : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse2_int16x8_avg_unsigned"
  [@@noalloc] [@@unboxed] [@@builtin]

external minpos_unsigned : t -> t @@ portable
  = "caml_sse2_unreachable" "caml_sse41_int16x8_minpos_unsigned"
  [@@noalloc] [@@unboxed] [@@builtin]

(* ───── Interleave ───── *)

external interleave_high_16 : t -> t -> t @@ portable
  = "caml_sse2_unreachable" "caml_simd_vec128_interleave_high_16"
  [@@noalloc] [@@unboxed] [@@builtin]
...
external cvt_si8 : t -> t -> int8x16# @@ portable
  = "caml_sse2_unreachable" "caml_sse2_cvt_int16x8_int8x16_saturating"
  [@@noalloc] [@@unboxed] [@@builtin]

external cvt_su8 : t -> t -> int8x16# @@ portable
  = "caml_sse2_unreachable" "caml_sse2_cvt_int16x8_int8x16_saturating_unsigned"
  [@@noalloc] [@@unboxed] [@@builtin]

external cvtsx_i32 : t -> int32x4# @@ portable
  = "caml_sse2_unreachable" "caml_sse41_cvtsx_int16x8_int32x4"
  [@@noalloc] [@@unboxed] [@@builtin]

external cvtzx_i32 : t -> int32x4# @@ portable
  = "caml_sse2_unreachable" "caml_sse41_cvtzx_int16x8_int32x4"
  [@@noalloc] [@@unboxed] [@@builtin]

external cvtsx_i64 : t -> int64x2# @@ portable
  = "caml_sse2_unreachable" "caml_sse41_cvtsx_int16x8_int64x2"
  [@@noalloc] [@@unboxed] [@@builtin]

external cvtzx_i64 : t -> int64x2# @@ portable
  = "caml_sse2_unreachable" "caml_sse41_cvtzx_int16x8_int64x2"
  [@@noalloc] [@@unboxed] [@@builtin]
