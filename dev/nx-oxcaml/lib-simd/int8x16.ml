...
let[@inline always] all_ones () = const1 #0xFFs
...
let[@inline] interleave_upper ~even ~odd = interleave_high_8 even odd
let[@inline] interleave_lower ~even ~odd = interleave_low_8 even odd
