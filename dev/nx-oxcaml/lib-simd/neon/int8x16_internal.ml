...
external low_to : t -> int8# @@ portable
  = "caml_vec128_unreachable" "caml_int8x16_low_to_int8"
  [@@noalloc] [@@builtin]

external const1 : int8# -> t @@ portable
  = "caml_vec128_unreachable" "caml_int8x16_const1"
  [@@noalloc] [@@builtin]
...
external add : t -> t -> t @@ portable
  = "caml_vec128_unreachable" "caml_neon_int8x16_add"
  [@@noalloc] [@@unboxed] [@@builtin]

external sub : t -> t -> t @@ portable
  = "caml_vec128_unreachable" "caml_neon_int8x16_sub"
  [@@noalloc] [@@unboxed] [@@builtin]
...
external abs : t -> t @@ portable
  = "caml_vec128_unreachable" "caml_neon_int8x16_abs"
  [@@noalloc] [@@unboxed] [@@builtin]

external neg : t -> t @@ portable
  = "caml_vec128_unreachable" "caml_neon_int8x16_neg"
  [@@noalloc] [@@unboxed] [@@builtin]
...
external max : t -> t -> t @@ portable
  = "caml_vec128_unreachable" "caml_neon_int8x16_max"
  [@@noalloc] [@@unboxed] [@@builtin]

external min : t -> t -> t @@ portable
  = "caml_vec128_unreachable" "caml_neon_int8x16_min"
  [@@noalloc] [@@unboxed] [@@builtin]
...
external movemask_8 : t -> int64# @@ portable
  = "caml_vec128_unreachable" "caml_neon_int8x16_movemask"
  [@@noalloc] [@@unboxed] [@@builtin]
