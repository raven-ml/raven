...
let cast_float64_float64 (src : float# array) (dst : float# array) n in_shape
...
let cast_float32_float32 (src : float32# array) (dst : float32# array) n in_shape
    in_offset in_strides out_offset out_strides =
  let md_index = Array.make (Array.length in_shape) 0 in
  for k = 0 to n - 1 do
    Shape.unravel_index_into k in_shape md_index;
...
let cast_int8_int8 (src : int8# array) (dst : int8# array) n in_shape in_offset
...
let cast_int16_int16 (src : int16# array) (dst : int16# array) n in_shape
    in_offset in_strides out_offset out_strides =
  let md_index = Array.make (Array.length in_shape) 0 in
  for k = 0 to n - 1 do
    Shape.unravel_index_into k in_shape md_index;
...
let cast_int32_int32 (src : int32# array) (dst : int32# array) n in_shape
    in_offset in_strides out_offset out_strides =
  let md_index = Array.make (Array.length in_shape) 0 in
  for k = 0 to n - 1 do
    Shape.unravel_index_into k in_shape md_index;
...
let cast_int64_int64 (src : int64# array) (dst : int64# array) n in_shape
    in_offset in_strides out_offset out_strides =
  let md_index = Array.make (Array.length in_shape) 0 in
  for k = 0 to n - 1 do
    Shape.unravel_index_into k in_shape md_index;
...
let cast_bool_bool (src : bool array) (dst : bool array) n in_shape in_offset
    in_strides out_offset out_strides =
  let md_index = Array.make (Array.length in_shape) 0 in
  for k = 0 to n - 1 do
    Shape.unravel_index_into k in_shape md_index;
