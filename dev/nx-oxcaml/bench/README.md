...
xychart-beta
    ...
    bar [1.45, 1.45, 56.28, 39.41, 44.48, 43.83, 71.39, 141.37, 377.31, 692.28]
    bar [0.87, 1.68, 12.60, 24.79, 55.54, 71.94, 102.38, 198.72, 405.33, 730.39]
```

Legend: First bar = Nx (C), Second bar = Nx (OxCaml)
