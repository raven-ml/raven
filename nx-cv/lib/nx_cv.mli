(** nx-cv: Computer vision operations on [Nx].
    ...
    edge detection using [Nx] buffers. *)
...
val box_filter : ksize:int * int -> ('a, 'b) Nx.t -> ('a, 'b) Nx.t
...
val blur : ksize:int * int -> ('a, 'b) Nx.t -> ('a, 'b) Nx.t
(** [blur ~ksize img]
