...
let () =
  (* Create a simple float32 Ndarray using your interface *)
  let npy_to_save =
  ...
  let packed_f32 : packed_ndarray = load_npy npy_load_path_f32 in
  ...
  let packed_i64 : packed_ndarray = load_npy npy_load_path_i64 in
  Format.printf "Loaded packed array from: %s\n" npy_load_path_i64;
