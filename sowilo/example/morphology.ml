...
let () =
  ...
  let kernel =
    time_it "Get Structuring Element (Rect 5x5)" (fun () ->
        get_structuring_element ~shape:Rect ~ksize:(5, 5) ~device:Rune.native)
  in
