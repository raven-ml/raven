...
let ndarray_int16 : (int, Nd.int16_elt) Nd.t testable =
  Alcotest.testable Nd.pp Nd.array_equal

let ndarray_int32 : (int32, Nd.int32_elt) Nd.t testable =
  Alcotest.testable Nd.pp Nd.array_equal

let ndarray_uint8 : (int, Nd.uint8_elt) Nd.t testable =
  Alcotest.testable Nd.pp Nd.array_equal
...
let test_fma () =
  ...
  Alcotest.(check ndarray_float32) "FMA float32" expected result
...
let test_fma_inplace () =
  ...
  let expected = Nd.create Nd.float32 [| 3 |] [| 7.0; 12.0; 19.0 |] in
  Alcotest.(check ndarray_float32) "FMA inplace float32" expected a;
