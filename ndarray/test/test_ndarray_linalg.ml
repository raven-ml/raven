...
let test_dot_1d_1d () =
  ...
  check ndarray_int32 "Dot product 1D x 1D" expected result
...
let test_dot_2d_2d () =
  ...
  check ndarray_float32 "Dot product 2D x 2D" expected result
...
let test_dot_2d_1d () =
  ...
  check ndarray_int32 "Dot product 2D x 1D" expected result
...
let test_dot_3d_2d () =
  ...
  in
  check ndarray_float32 "Dot product 3D x 2D" expected result
...
let test_matmul_2x3_3x2 () =
  ...
  in
  check ndarray_float32 "Matmul 2x3 with 3x2" expected result
...
let test_convolve1d () =
  ...
  check ndarray_float32 "Convolve 1D" expected result
...
let test_solve_with_matrix_b () =
  ...
  check ndarray_float32 "Solve with matrix b" b reconstructed_b
...
let test_svd_reconstruction () =
  ...
  check ndarray_float32 "SVD reconstruction" t reconstructed
...
let () =
  ...
  Alcotest.run "Ndarray Operations" [ ("Operations", operation_tests) ]
